...
abstract class SampleBaseActivity<VB : ViewBinding> : BasePageActivity<VB, SampleAppBarView>() {
    ...
    override fun onCreateViewBinding(
        ...
        val vbType = (javaClass.genericSuperclass as ParameterizedType).actualTypeArguments[0] as Class<VB>
        // return vbType.getMethod("inflate", LayoutInflater::class.java).invoke(null, inflater) as VB
        return ReflectUtils.reflect(vbType).method("inflate", inflater).get()
    }
